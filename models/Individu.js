...
class Individu {
	...
	static create(content, cb) {
		...
		+'ville_residence = ?, statut = ?, telephone = ?, motdepasse = ?, cle_api = ?, date_register = ?'
		connection.query(sql, [codeIndividu, nom, prenom, sexe, age, villeResidence, statut, telephone, motdepasse, cleApi, dateRegister],
			(err, result) => {
				if (err) throw err
